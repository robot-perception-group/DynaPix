...
cv::Mat System::TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const cv::Mat &probmap, cv::Mat &mask,
                          ...
                          cv::Mat &imDOut, cv::Mat &maskOut)
{
    ...
    cv::Mat Tcw = mpTracker->GrabImageRGBD(im,depthmap,probmap, mask,timestamp,imRGBOut,imDOut,maskOut);
