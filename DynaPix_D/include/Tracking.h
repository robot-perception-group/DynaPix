...
public:
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB, const cv::Mat &imD, const cv::Mat & imP, cv::Mat &mask, const double &timestamp, cv::Mat &imRGBOut, cv::Mat &imDOut, cv::Mat &maskOut);
